...
<div class="content-wrapper">
    ...
    <div class="content-body">
        ...
        <div class="row mt-3">
            ...
            <div class="col-4 quick-link text-right mt-3">
            ...
            <div class="col-lg-8">
                <div class="row">
                        ...
                        <div class="carousel-caption d-none d-md-block text-left">
                            ...
                            <div class="row">
                                ...
                                <div class="text-right col-4 mt-5">
                                    <a href="client-grid.html"> <button class=" px-2 grey-bg">Chat
                                            Now</button></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-5 mt-lg-0 mt-2 img-width">
                        ...
                        <div class="caro-caption d-none d-md-block text-left">
                            <div class="row">
                                <div class="col-8">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-lg-4 my-lg-0 my-2">
                        <div class="raise-bg-img">
                            <div class="raise-bg-img">
                                <div class="layer"></div>
                                <div class="text-over-img px-lg-2 px-5 py-2">
            ...
            <div class="col-lg-4">
                <div id="inbox-msg" class="py-2 px-3">
                    ...
                    <div class="text-center stylish-img">
                        <img src="{{ asset('member/app-assets/images/gallery/stylist.png') }}" class="img-fluid" alt="">
                    ...
                    <div class="row">
                        <div class="col-lg-2 col-1">
                            <img src="{{ asset('member/app-assets/images/gallery/progil2.png') }}" alt="Avatar">
                        </div>
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-2">
                            <img src="{{ asset('member/app-assets/images/gallery/Profile Picture.png') }}" alt="Avatar">
                        </div>
                    </div>
                ...
                <div id="TabContent" class="tab-content mt-2">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <div id="onePagecarousel" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    ...
                                    <div class="carousel-caption d-none d-md-block text-left w-100">
                                        ...
                                        <div class="row pt-3 pb-1">
                                            ...
                                            <div class="text-right col-4 mt-5 pt-2">
                                ...
                                <img class="d-block" src="app-assets/images/gallery/1.jpg" alt="Second slide">
                              </div>
                              <div class="carousel-item">
                                <img class="d-block" src="app-assets/images/gallery/11.jpg" alt="Third slide">
                              </div> -->
                            </div>
                    ...
                    <div class="tab-pane fade " id="Beauty" role="tabpanel" aria-labelledby="Beauty-tab">
                        <div id="onePagecarousel" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block " src="{{ asset('member/app-assets/images/gallery/best-bedroom.svg') }}"
                                        alt="First slide">
                                    <div class="carousel-caption d-none d-md-block text-left w-100">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="d-flex">
                        ...
                        <h2 class="px-2 mt-1">Across Fashion, Home & Beauty</h2>
                    </div>
                </div>
                <!-- Pills navs -->
                    ...
                    <div class="tab-pane fade active show" id="Fashion_1" role="tabpanel"
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card">
                                    <img class="card-img-top"
                                        src="{{ asset('member/app-assets/images/gallery/client-dash-browse1.png') }}"
                                        alt="Card image cap">
                                    <div class="card-body">
                            ...
                            <div class="col">
                                <div class="card">
                                    <img class="card-img-top"
                                        src="{{ asset('member/app-assets/images/gallery/client-dash-browse2.png') }}"
                                        alt="Card image cap">
                                    <div class="card-body">
                                        <h5 class="card-title">BOTTEGA VENETA</h5>
                            ...
                            <div class="col">
                                <div class="card">
                                    <img class="card-img-top"
                                        src="{{ asset('member/app-assets/images/gallery/client-dash-browse3.png') }}"
                                        alt="Card image cap">
                                    <div class="card-body">
                                        <h5 class="card-title">BOTTEGA VENETA</h5>
                            ...
                            <div class="col">
                                <div class="card">
                                    <img class="card-img-top"
                                        src="{{ asset('member/app-assets/images/gallery/client-dash-browse4.png') }}"
                                        alt="Card image cap">
                                    <div class="card-body">
                            ...
                            <div class="col">
                                <div class="card">
                                    <img class="card-img-top"
                                        src="{{ asset('member/app-assets/images/gallery/client-dash-browse5.png') }}"
                                        alt="Card image cap">
                                    <div class="card-body">
                                        <h5 class="card-title">LOEWE</h5>
                        ...
                        <div class="d-flex px-2 mt-2">
                            <div class="show-bg"><img src="{{ asset('member/app-assets/images/icons/show-more.svg') }}" alt="">
                            </div>
        ...
        <div id="payment-center" class="mt-3">
            <div class="row">
                <div class="col-lg-6">
                    <div class="client-raise-bg raise-bg px-3 py-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col mt-2 text-lg-left text-right">
                                <img src="{{ asset('member/app-assets/images/gallery/Shopping Bag.png') }}" class="img-fluid" alt="">
                            </div>
                        </div>
                    ...
                    <div class="my-2">
                        <div class="client-raise-bg raise-bg px-3 py-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col mt-2 text-lg-left text-right">
                                    <img src="{{ asset('member/app-assets/images/gallery/logo2.png') }}" class="img-fluid" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div id="notice-board" class="raise-bg_1 pb-1">
                        <div class="">
                            ...
                            <!-- <div class="col-3">
                                <img src="app-assets/images/icons/Pin.svg" class="img-fluid" alt="">
                            </div> -->
                        ...
                        <div class="mx-2" id="board-detail">
                            <div class="row mx-2 my-1">
                                ...
                                <div class="col-3">
                                    <img src="{{ asset('member/app-assets/images/icons/notice-board.svg') }}" class="img-fluid py-1"
                                        alt="">
                                </div>
                            </div>
                            <div class="row mx-2 my-1">
                                ...
                                <div class="col-3">
                                    <img src="{{ asset('member/app-assets/images/icons/notice-board1.png') }}" class="img-fluid py-1"
                                        alt="">
                                </div>
                            </div>
                            <div class="row mx-2 mt-1">
                                ...
                                <div class="col-3">
                                    <img src="{{ asset('member/app-assets/images/icons/notice2.svg') }}" class="img-fluid py-1"
                                        alt="">
                                </div>
                            </div>
