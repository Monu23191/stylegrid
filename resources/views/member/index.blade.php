                    ...
                    <div class="col-lg-4">
                        <div id="inbox-msg" class="py-2 px-3">
                            ...
                            <div class="text-center stylish-img">
                                <img src="member/app-assets/images/gallery/stylist.png" class="img-fluid" alt="">
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-1">
                                    <img src="member/app-assets/images/gallery/progil2.png" alt="Avatar">
                                </div>
                            ...
                            <div class="row mt-1">
                                ...
                                <div class="col-2">
                                    <img src="member/app-assets/images/gallery/Profile Picture.png" alt="Avatar">
                                </div>
                            </div>
                        ...
                        <div id="TabContent" class="tab-content mt-2">
                            ...
                            <div class="tab-pane fade " id="Beauty" role="tabpanel" aria-labelledby="Beauty-tab">
                                <div id="onePagecarousel" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img class="d-block " src="member/app-assets/images/gallery/best-bedroom.svg"
                                                alt="First slide">
                            ...
                            <div class="tab-pane fade active show" id="Fashion_1" role="tabpanel"
                                ...
                                <div class="row mx-md-0 mx-2">
                                    <div class="col-md col-6">
                                        <div class="card">
                                            <img class="card-img-top"
                                                src="member/app-assets/images/gallery/client-dash-browse1.png"
                                                alt="Card image cap">
                                            <div class="card-body">
                                    ...
                                    <div class="col-md col-6">
                                        <div class="card">
                                            <img class="card-img-top"
                                                src="member/app-assets/images/gallery/client-dash-browse2.png"
                                                alt="Card image cap">
                                            <div class="card-body">
                                                <h5 class="card-title">BOTTEGA VENETA</h5>
                                    ...
                                    <div class="col-md col-6">
                                        <div class="card">
                                            <img class="card-img-top"
                                                src="member/app-assets/images/gallery/client-dash-browse3.png"
                                                alt="Card image cap">
                                            <div class="card-body">
                                                <h5 class="card-title">BOTTEGA VENETA</h5>
                                    ...
                                    <div class="col-md col-6">
                                        <div class="card">
                                            <img class="card-img-top"
                                                src="member/app-assets/images/gallery/client-dash-browse4.png"
                                                alt="Card image cap">
                                            <div class="card-body">
                                    ...
                                    <div class="col-md col-6">
                                        <div class="card">
                                            <img class="card-img-top"
                                                src="member/app-assets/images/gallery/client-dash-browse5.png"
                                                alt="Card image cap">
                                            <div class="card-body">
                                                <h5 class="card-title">LOEWE</h5>
                                ...
                                <div class="d-flex px-2 mt-2">
                                    <div class="show-bg"><img src="member/app-assets/images/icons/show-more.svg" alt="">
                                    </div>
                            ...
                            <div class="client-raise-bg raise-bg px-md-3 px-2 py-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col mt-2 text-lg-left text-right">
                                        <img src="member/app-assets/images/gallery/Shopping Bag.png" class="img-fluid" alt="">
                                    </div>
                                </div>
                            ...
                            <div class="my-2">
                                <div class="client-raise-bg raise-bg px-md-3 px-2 py-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col mt-2 text-lg-left text-right">
                                            <img src="member/app-assets/images/gallery/logo2.png" class="img-fluid" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="notice-board" class="raise-bg_1 pb-1">
                                ...
                                <div class="mx-md-2" id="board-detail">
                                    <div class="row mx-md-2 mx-1 my-1">
                                        ...
                                        <div class="col-3">
                                            <img src="member/app-assets/images/icons/notice-board.svg" class="img-fluid py-1"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="row mx-2 my-1">
                                        ...
                                        <div class="col-3">
                                            <img src="member/app-assets/images/icons/notice-board1.png" class="img-fluid py-1"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="row mx-2 mt-1">
                                        ...
                                        <div class="col-3">
                                            <img src="member/app-assets/images/icons/notice2.svg" class="img-fluid py-1"
                                                alt="">
                                        </div>
                                    </div>
