    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
        <div class="main-menu-content">
            ...
            <div class="row mx-1 py-1 social-media-border my-4">
                <div class="mx-auto"><a href=""><img src="{{ asset('member/app-assets/images/icons/Instagram.png') }}" alt=""></a></div>
                <div class="mx-auto"><a href=""><img src="{{ asset('member/app-assets/images/icons/facebook.png') }}" alt=""></a></div>
                <div class="mx-auto"><a href=""><img src="{{ asset('member/app-assets/images/icons/Twitter Squared.png') }}" alt=""></a></div>
                <div class="mx-auto"><a href=""><img src="{{ asset('member/app-assets/images/icons/TikTok.png') }}" alt=""></a></div>
                <div class="mx-auto"><a href=""><img src="{{ asset('member/app-assets/images/icons/LinkedIn.png') }}" alt=""></a></div>
            </div>
