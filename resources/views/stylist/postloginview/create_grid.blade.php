...
function makeTrim(x) {
   ...
   // $('#image_preview_remove').click(function(){
    ...
    // $(".modal in").on('change',function () {
		...
		var modal='<div class="modal" id="'+myArray[1]+'" class="mjmodal" tabindex="-1" role="dialog" aria-labelledby="acceptLabel" aria-hidden="true" style="height: 80%;"><div class="modal-dialog" role="document"><div class="modal-content pt-1"><div class="mr-2"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><div class="modal-body py-2"><h1 class="text-center modal-submit-request">Submit Sourcing Request</h1><div id="browse-soursing" class="mt-2">';

				    modal +=' <form id="submit-request" action="client-submit-request-complete.html" class=" ">';
                   modal +='<div class="row align-items-center" id="fulfill-request"><div class="col-lg-6" ><div class="Neon Neon-theme-dragdropbox mt-3"><input name="files[]"  multiple="multiple" name="prd_img" idattr="'+myArray[1]+'" id="prd_img'+myArray[1]+'" onchange="mjtest1(this)" type="file"><div class="Neon-input-dragDrop py-5 px-4"><div class="Neon-input-inner py-4"><div class="Neon-input-text "><h3>Upload an image of the product here</h3></div><a class="Neon-input-choose-btn blue"><imgsrc="app-assets/images/icons/plus.png" alt="" id="image_preview'+myArray[1]+'"></a>';
